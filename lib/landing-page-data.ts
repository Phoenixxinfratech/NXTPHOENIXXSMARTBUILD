...
export const products: Record<string, ProductData> = {
  'sandwich-puf-panel': {
    ...
    specifications: {
      ...
      fireRating: 'B3 (DIN 4102) / Class E (EN 13501-1), self-extinguishing; B2 and B1 available on request',
  ...
  'roofing-puf-panel': {
    ...
    specifications: {
      ...
      density: '40 ± 2 kg/m³',
      thermalConductivity: '0.024 W/mK',
      fireRating: 'B3 (DIN 4102) / Class E (EN 13501-1) standard; B2 and B1 available',
