        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-violet-600 to-purple-700 text-white">
          <div className="container-custom text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="https://wa.me/918866556879?text=Hi%20PHOENIXX,%20I%20need%20PUF%20panels%20for%20Dholera%20SIR%20project" target="_blank" rel="noopener noreferrer" className="rounded-xl border-2 border-white px-8 py-4 font-semibold text-white hover:bg-white/10 transition-all">💬 WhatsApp Enquiry</a>
            </div>
          </div>
        </section>
        <CityManufacturerAeo cityName="Dholera" />
