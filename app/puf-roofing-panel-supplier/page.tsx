      ...
      <main id="main-content" className="flex-1">
        ...
        <section className="relative bg-gradient-to-br from-slate-900 via-gray-900 to-blue-900 py-20 md:py-28">
          ...
          <div className="container-custom relative">
            <Breadcrumbs withSchema items={[{ label: 'PUF Roofing Panels', href: '/puf-roofing-panels' }, { label: 'Supplier' }]} />
        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-green-600 to-emerald-700 text-white">
          <div className="container-custom text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href="https://wa.me/918866556879?text=Hi%20Phoenixx,%20I%20need%20PUF%20roofing%20panels%20supplied"
                target="_blank"
