...
const solutions = [
  ...
  },
  {
    ...
    tagline: 'Accessible Service Platforms',
    description: 'Heavy-duty ceiling systems with load-bearing capacity for equipment access, maintenance, and service operations. Designed for industrial and commercial facilities requiring overhead access.',
    benefits: ['Load capacity up to 200 kg/m²', 'Easy maintenance access', 'Equipment mounting', 'Structural integrity'],
    applications: ['Cleanrooms', 'Pharmaceutical', 'Semiconductor', 'Data Centers', 'Industrial Facilities'],
  ...
  },
  {
    ...
    tagline: 'Lightweight & Aesthetic Solutions',
    description: 'Lightweight ceiling panels designed for aesthetic appeal, acoustic control, and basic service access. Ideal for offices, commercial spaces, and cleanrooms without heavy equipment requirements.',
    benefits: ['Lightweight construction', 'Aesthetic finishes', 'Acoustic control', 'Easy installation'],
    applications: ['Offices', 'Commercial Buildings', 'Cleanrooms', 'Healthcare', 'Educational Facilities'],
