...
const solutionsData: Record<string, {
  ...
  'non-walkable-ceiling-systems': {
    ...
    seoTitle: 'Non-Walkable False Ceiling Manufacturer | Industrial Ceiling Panels | PHOENIXX',
    tagline: 'Cost-Effective Ceiling Solutions',
    description: 'Lightweight ceiling systems for applications where maintenance access from above is not required.',
    seoDescription: 'PHOENIXX manufactures non-walkable ceiling systems: Lightweight panels for offices, commercial spaces, and industrial applications. Cost-effective alternative to walkable systems. Quick installation.',
    longDescription: 'PHOENIXX Non-Walkable Ceiling Systems provide cost-effective solutions for applications where access from above is not needed. Ideal for offices, commercial spaces, and industrial areas with accessible mechanical rooms, these systems offer excellent aesthetics and thermal performance at reduced cost.',
    aiSummary: 'PHOENIXX manufactures Non-Walkable Ceiling Systems: Lightweight panels for commercial and industrial applications. Applications: Offices, retail spaces, industrial facilities. Features: Cost-effective, quick installation, thermal insulation, acoustic control. Alternative to walkable ceilings where maintenance access not required.',
    keywords: ['non-walkable ceiling', 'false ceiling panels', 'lightweight ceiling', 'office ceiling', 'industrial ceiling', 'ceiling tiles'],
    gradient: 'from-slate-600 to-zinc-600',
    stats: [
      { value: '30%', label: 'Cost Savings vs Walkable' },
      { value: '50+', label: 'Projects Completed' },
      { value: 'Quick', label: 'Installation' },
      { value: 'Rw 25-35', label: 'Acoustic Rating (dB)' },
    ],
    benefits: [
      { icon: '💰', title: 'Cost-Effective', description: 'Up to 30% cost savings compared to walkable systems, ideal for budget-conscious projects.' },
      { icon: '⚡', title: 'Quick Installation', description: 'Lightweight panels enable faster installation—100-200 sq.ft per day, reducing project timelines.' },
      { icon: '🎨', title: 'Aesthetic Finish', description: 'Clean, uniform appearance with various finishes for commercial and office environments.' },
      { icon: '🌡️', title: 'Thermal Insulation', description: 'PUF/mineral wool core provides thermal insulation, reducing HVAC load and energy costs.' },
    ],
    productsUsed: [
      { name: 'Wall & Ceiling Panels', description: 'Lightweight insulated panels for ceiling applications', link: '/products/sandwich-panels/wall-ceiling-panel' },
      { name: 'Cleanroom Partitions', description: 'Integrated wall-ceiling systems', link: '/products/cleanroom-solutions/cleanroom-partition' },
    ],
    process: [
      { step: 1, title: 'Assessment', description: 'Evaluating ceiling area, aesthetic requirements, and acoustic needs.' },
      { step: 2, title: 'Design', description: 'Grid layout design and service point coordination.' },
      { step: 3, title: 'Fabrication', description: 'Manufacturing ceiling panels and grid systems.' },
      { step: 4, title: 'Installation', description: 'Suspended grid installation and panel fitting.' },
      { step: 5, title: 'Finishing', description: 'Lighting, AC diffusers, and final touches.' },
    ],
    applications: [
      { question: 'When are non-walkable ceilings suitable?', answer: 'Non-walkable ceilings are ideal when mechanical services are accessible from ground level or mechanical rooms, when budget is a primary concern, and when maintenance personnel do not need to walk on the ceiling.' },
      { question: 'What panel materials are available?', answer: 'Options include PUF panels (thermal + acoustic), mineral fiber tiles (acoustic focus), gypsum panels (fire-rated), and metal panels (industrial aesthetic). Selection depends on requirements.' },
      { question: 'Can lights and AC be integrated?', answer: 'Yes. Recessed LED panels, AC diffusers, and other services can be integrated. However, maintenance access is from below using ladders or lifts rather than from above.' },
    ],
    industries: ['Commercial Offices', 'Retail', 'Hospitality', 'Industrial', 'Educational', 'Healthcare'],
    testimonial: {
    ...
    faqs: [
      ...
      { question: 'How is maintenance performed?', answer: 'Maintenance is performed from below using ladders, scaffolding, or aerial lifts. Panels can be removed from below for access to above-ceiling services.' },
      { question: 'What fire ratings are available?', answer: 'Options include 30-minute, 60-minute, and 120-minute fire-rated assemblies depending on building code requirements. We provide fire test certificates.' },
      { question: 'Can non-walkable be used in cleanrooms?', answer: 'For lower ISO classes (Class 7-8) where above-ceiling maintenance is infrequent, non-walkable ceilings with proper sealing can be suitable. Higher classifications typically require walkable systems.' },
    ],
  },
  'partition-solutions': {
  ...
  'cleanroom-solutions': {
    ...
    seoTitle: 'Cleanroom Construction Company India | Modular Cleanroom Manufacturer | PHOENIXX',
    tagline: 'Complete Contamination-Controlled Environments',
    description: 'Turnkey cleanroom construction for pharmaceutical, biotech, electronics, and food processing industries.',
    seoDescription: 'PHOENIXX builds modular cleanrooms (ISO Class 5-8) for pharma, biotech & electronics. GMP/FDA compliant. Partitions, ceilings, doors, flooring & HVAC. Get free quote.',
    longDescription: 'PHOENIXX Cleanroom Solutions deliver complete contamination-controlled environments from design to validation. Our modular approach enables faster construction, easier expansion, and compliance with ISO 14644, WHO GMP, and US FDA standards for pharmaceutical, biotech, electronics, and food processing facilities.',
    aiSummary: 'PHOENIXX builds turnkey cleanrooms in India: ISO Class 5-8, GMP/FDA compliant. Components: Partitions, false ceilings, doors, flooring, HVAC integration. Industries: Pharma, biotech, electronics, food processing. Features: Modular design, quick installation, easy validation. Location: Ahmedabad, Pan-India delivery.',
    keywords: ['cleanroom construction', 'modular cleanroom', 'cleanroom manufacturer', 'GMP cleanroom', 'ISO cleanroom', 'pharma cleanroom', 'cleanroom partition', 'cleanroom ceiling'],
    gradient: 'from-emerald-600 to-teal-600',
    stats: [
      { value: '200+', label: 'Cleanrooms Built' },
      { value: 'ISO 5-8', label: 'Classifications' },
      { value: '98%', label: 'Client Satisfaction' },
      { value: 'Pan India', label: 'Service Network' },
    ],
    benefits: [
      { icon: '🔬', title: 'ISO Compliant', description: 'Cleanrooms designed and built to meet ISO 14644-1 Class 5 through Class 8 requirements.' },
      { icon: '💊', title: 'GMP/FDA Ready', description: 'Facilities compliant with WHO GMP, US FDA, and EU GMP guidelines for pharmaceutical manufacturing.' },
      { icon: '🧩', title: 'Modular Design', description: 'Pre-engineered modular systems for rapid installation, easy expansion, and future reconfiguration.' },
      { icon: '✅', title: 'Turnkey Delivery', description: 'Complete solutions from design and engineering through construction, HVAC integration, and validation.' },
    ],
    productsUsed: [
      { name: 'Cleanroom Partitions', description: 'Modular wall systems with flush surfaces and cam-lock joints', link: '/products/cleanroom-solutions/cleanroom-partition' },
      { name: 'Cleanroom False Ceiling', description: 'Walkable and non-walkable ceiling systems with HEPA integration', link: '/products/cleanroom-solutions/cleanroom-false-ceiling' },
      { name: 'Cleanroom Doors', description: 'Airtight swing, sliding, and hermetic doors', link: '/products/cleanroom-solutions/cleanroom-doors' },
      { name: 'Cleanroom Flooring', description: 'Seamless epoxy and PU flooring systems', link: '/products/cleanroom-solutions/cleanroom-flooring' },
    ],
    process: [
      { step: 1, title: 'Consultation & Design', description: 'Understand your process requirements, classify cleanroom zones, and develop detailed layouts.' },
      { step: 2, title: 'Engineering', description: 'Structural calculations, HVAC design, air change rates, and pressure cascade planning.' },
      { step: 3, title: 'Manufacturing', description: 'Factory production of partitions, ceilings, doors, and accessories with quality control.' },
      { step: 4, title: 'Installation', description: 'On-site erection by trained teams with minimal disruption to existing operations.' },
      { step: 5, title: 'Validation & Handover', description: 'Particle count testing, DOP testing, air velocity checks, and IQ/OQ documentation.' },
    ],
    applications: [
      { question: 'What cleanroom classifications do you build?', answer: 'We design and construct cleanrooms from ISO Class 5 (Class 100) to ISO Class 8 (Class 100,000). The classification is determined by your process requirements, and we engineer the HVAC, filtration, and construction accordingly.' },
      { question: 'Are your cleanrooms suitable for pharmaceutical manufacturing?', answer: 'Yes. Our cleanrooms meet WHO GMP, US FDA 21 CFR, and EU GMP Annex 1 requirements. We provide complete documentation including DQ, IQ, OQ protocols for regulatory compliance.' },
      { question: 'Can you build cleanrooms for electronics and semiconductor?', answer: 'Yes. We build ESD-safe cleanrooms for semiconductor fabrication, PCB assembly, and precision electronics manufacturing with appropriate grounding, materials, and air filtration systems.' },
      { question: 'Do you handle HVAC integration?', answer: 'Yes. Our turnkey approach includes complete HVAC design with AHU sizing, ductwork, HEPA/ULPA filtration, pressure cascade design, and BMS integration for automated environmental monitoring.' },
    ],
    industries: ['Pharmaceutical', 'Biotechnology', 'Electronics', 'Food Processing', 'Healthcare', 'Research Labs'],
    testimonial: {
    ...
    faqs: [
      ...
      { question: 'How long does cleanroom construction take?', answer: 'Modular cleanroom construction typically takes 4-8 weeks depending on size and complexity. Our prefabricated approach is 40-50% faster than conventional construction methods.' },
      { question: 'What documentation do you provide?', answer: 'Complete validation documentation including Design Qualification (DQ), Installation Qualification (IQ), Operational Qualification (OQ), material certificates, test reports, and as-built drawings.' },
      { question: 'Can existing facilities be converted to cleanrooms?', answer: 'Yes. We specialize in retrofitting existing buildings into cleanrooms. Our modular systems can be installed within existing structures with minimal structural modifications.' },
      { question: 'Do you provide maintenance services?', answer: 'Yes. We offer annual maintenance contracts (AMC) covering HEPA filter replacement, partition repairs, door servicing, and periodic re-validation testing.' },
      { question: 'What HVAC systems do you use?', answer: 'We design custom HVAC systems with AHUs, HEPA/ULPA filters (99.97-99.999% efficiency), precise temperature control (±1°C), and humidity control (±5% RH). BMS integration available.' },
    ],
  },
};
