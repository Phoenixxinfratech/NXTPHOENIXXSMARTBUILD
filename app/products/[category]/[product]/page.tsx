...
const productsData: Record<string, Record<string, ProductData>> = {
  'sandwich-panels': {
    ...
    'roofing-puf-panel': {
      ...
      description: 'High-performance PUF roofing panels with trapezoidal profile for superior weather resistance and thermal insulation.',
      longDescription: 'PHOENIXX Roofing PUF Panels are specifically designed for industrial and commercial roofing applications. The trapezoidal profile provides excellent structural strength and water drainage, while the PUF core ensures superior thermal insulation and energy efficiency. Engineered to withstand extreme weather conditions across India.',
      metaTitle: 'Roofing PUF Panels | Insulated Roof Sheets | PHOENIXX',
      metaDescription: 'Trapezoidal roofing PUF panels with superior weatherproofing & thermal insulation. Up to 14m length, 30-100mm thickness. Leading manufacturer in India.',
      features: [
        { title: 'Trapezoidal Profile', description: 'Optimized shape for superior structural strength and efficient water drainage.', icon: '🏠' },
        { title: 'Weather Resistance', description: 'UV-stabilized coatings and sealed joints protect against harsh weather conditions.', icon: '☀️' },
        { title: 'Thermal Performance', description: 'PUF core provides excellent thermal insulation reducing HVAC costs.', icon: '❄️' },
        { title: 'Long Span Capability', description: 'Supports longer spans reducing structural steel requirements.', icon: '📏' },
      ],
      benefits: [
        { title: 'Leak-Proof Design', description: 'Concealed fixing system and sealed joints eliminate water ingress.' },
        { title: 'Reduced Steel Cost', description: 'Longer spans mean fewer purlins and reduced structural steel weight.' },
        { title: 'Year-Round Comfort', description: 'Keeps interiors cool in summer and warm in winter.' },
        { title: '15-Year Warranty', description: 'Extended warranty on coating against fading and corrosion.' },
      ],
      specifications: [
        {
          category: 'Core Properties',
      ...
      applications: [
        { name: 'Industrial Warehouses', description: 'Large-span roofing for logistics and storage facilities.' },
        { name: 'Factory Buildings', description: 'Temperature-controlled manufacturing environments.' },
        { name: 'Cold Storage Roofs', description: 'Insulated roofing for refrigerated warehouses.' },
        { name: 'Commercial Buildings', description: 'Energy-efficient roofing for offices and retail.' },
        { name: 'Agricultural Sheds', description: 'Poultry houses, dairy farms, and grain storage.' },
      ],
      faqs: [
        { question: 'What is the maximum span for roofing PUF panels?', answer: 'PHOENIXX roofing panels can span up to 3-4 meters between purlins depending on thickness and load requirements. 50mm panels typically span 2.5m, while 80mm panels can span 3.5m.' },
        { question: 'Are roofing PUF panels waterproof?', answer: 'Yes, with proper installation including sealed joints, ridge caps, and gutters, roofing PUF panels provide complete waterproofing. Our panels have been tested for water tightness as per IS standards.' },
        { question: 'What slope is required for PUF roofing?', answer: 'Minimum 5% slope (1:20) is recommended for proper water drainage. Higher slopes improve drainage and reduce ponding risk.' },
        { question: 'Can roofing panels withstand cyclone conditions?', answer: 'Yes, our roofing system is designed to withstand wind speeds up to 180 km/h when properly installed with recommended fastener spacing and sealing.' },
        { question: 'What is the weight of roofing PUF panels?', answer: 'Roofing PUF panels weigh 9-15 kg/sqm depending on thickness, significantly lighter than RCC roofs (150-200 kg/sqm), reducing structural requirements.' },
        { question: 'How is condensation prevented?', answer: 'The insulated core prevents temperature differential that causes condensation. For high-humidity environments, vapor barriers can be added.' },
        { question: 'What is the lifespan of roofing PUF panels?', answer: 'PHOENIXX roofing panels last 20-25 years with proper maintenance. PVDF-coated panels can last even longer with superior UV resistance.' },
        { question: 'Can solar panels be installed on PUF roofing?', answer: 'Yes, solar panels can be installed using non-penetrating mounting systems or with proper flashing and sealing for through-fixings.' },
        { question: 'What accessories are needed for complete roofing?', answer: 'Complete roofing system includes ridge caps, gutter, downpipes, flashing, fasteners, and sealants. PHOENIXX provides all accessories for a complete solution.' },
        { question: 'Is special equipment needed for installation?', answer: 'Basic equipment includes lifting equipment (crane/forklift), screw guns, sealant guns, and safety equipment. No specialized tools required.' },
        { question: 'What is the difference between roofing and wall PUF panels?', answer: 'Roofing panels have trapezoidal profiles for water drainage and structural strength, while wall panels have flat or micro-rib profiles for aesthetics. Core properties are similar.' },
        { question: 'How to maintain PUF roofing panels?', answer: 'Annual cleaning with water and mild detergent, inspection of joints and fasteners, and clearing debris from gutters is sufficient. No painting required.' },
        { question: 'What colors are best for roofing?', answer: 'Lighter colors (white, light grey) reflect more heat and are recommended for hot climates. Darker colors absorb heat but may be preferred for aesthetic reasons.' },
        { question: 'Can roofing panels be curved?', answer: 'Yes, curved roofing panels can be manufactured for architectural applications with minimum radius requirements based on thickness.' },
        { question: 'What certification do roofing panels have?', answer: 'PHOENIXX roofing panels are tested as per IS 14925, comply with NBC 2016, and are ISO 9001 certified for quality management.' },
      ],
      relatedProducts: [
        { name: 'Sandwich PUF Panels', slug: 'sandwich-puf-panel', category: 'sandwich-panels' },
        { name: 'Wall & Ceiling Panels', slug: 'wall-ceiling-panel', category: 'sandwich-panels' },
