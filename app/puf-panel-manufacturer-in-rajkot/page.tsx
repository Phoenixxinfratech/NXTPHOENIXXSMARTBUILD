...
export const metadata: Metadata = {
  title: 'PUF Panel Manufacturer in Rajkot',
  ...
  openGraph: {
    ...
    description: 'Top PUF panel supplier in Rajkot, Gujarat. Industrial insulated panels for warehouses and cold storage. Get quote!',
    url: 'https://phoenixxsmartbuild.com/puf-panel-manufacturer-in-rajkot',
      ...
      <main id="main-content" className="flex-1">
        ...
        <section className="relative bg-gradient-to-br from-blue-900 via-indigo-900 to-slate-900 py-20 md:py-28">
          ...
          <div className="container-custom relative">
            <Breadcrumbs withSchema items={[{ label: 'Products', href: '/products' }, { label: 'PUF Panel Manufacturer in Rajkot' }]} />
            ...
            <div className="max-w-4xl">
              ...
              <p className="mt-6 text-xl text-slate-300 max-w-3xl">Metoda and Lodhika engineering units lose floor productivity when sheds overheat. PHOENIXX supplies PUF roofing and wall panels to Rajkot with large-span profiles and coatings suited to Saurashtra heat and dusty workshop conditions.</p>
        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
          <div className="container-custom text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="https://wa.me/918866556879?text=Hi%20PHOENIXX,%20I%20need%20PUF%20panels%20in%20Rajkot" target="_blank" rel="noopener noreferrer" className="rounded-xl border-2 border-white px-8 py-4 font-semibold text-white hover:bg-white/10 transition-all">💬 WhatsApp Enquiry</a>
            </div>
          </div>
        </section>
        <CityManufacturerAeo cityName="Rajkot" />
