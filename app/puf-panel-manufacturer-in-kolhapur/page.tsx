...
export const metadata: Metadata = {
  title: 'PUF Panel Manufacturer in Kolhapur',
  ...
  keywords: ['PUF panel manufacturer in Kolhapur', 'PUF panel Shiroli MIDC', 'insulated panel Kolhapur'],
  ...
  openGraph: {
    ...
    description: 'Quality PUF panels in Kolhapur for industrial and cold storage projects. Fast delivery to Kolhapur region. Contact us!',
    url: 'https://phoenixxsmartbuild.com/puf-panel-manufacturer-in-kolhapur',
      ...
      <main id="main-content" className="flex-1">
        ...
        <section className="relative bg-gradient-to-br from-rose-900 via-pink-900 to-slate-900 py-20 md:py-28">
          ...
          <div className="container-custom relative">
            <Breadcrumbs withSchema items={[{ label: 'Products', href: '/products' }, { label: 'PUF Panel Manufacturer in Kolhapur' }]} />
          ...
          <div className="container-custom">
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-6">
              {['Foundry & Casting Units', 'Dairy Processing Plants', 'Sugar & Jaggery Industries', 'Cold Storage Facilities', 'Auto Component Manufacturing', 'Textile Industries (Ichalkaranji)', 'Food Processing Units', 'Commercial Buildings'].map((app, idx) => (
                <div key={idx} className="flex items-center gap-3 p-4 bg-slate-50 rounded-lg"><span className="text-rose-500" aria-hidden="true">✓</span><span className="text-slate-700">{app}</span></div>
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-rose-600 to-pink-700 text-white">
          <div className="container-custom text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="https://wa.me/918866556879?text=Hi%20PHOENIXX,%20I%20need%20PUF%20panels%20in%20Kolhapur" target="_blank" rel="noopener noreferrer" className="rounded-xl border-2 border-white px-8 py-4 font-semibold text-white hover:bg-white/10 transition-all">💬 WhatsApp Enquiry</a>
            </div>
          </div>
        </section>
        <CityManufacturerAeo cityName="Kolhapur" />
