...
export const metadata: Metadata = {
  title: 'PUF Panel Manufacturer in Nashik',
  ...
  keywords: ['PUF panel manufacturer in Nashik', 'PUF panel Ambad MIDC', 'cold storage panel Nashik'],
  ...
  openGraph: {
    ...
    description: 'Quality PUF panels in Nashik for industrial and cold storage applications. Fast delivery to Nashik MIDC. Contact now!',
    url: 'https://phoenixxsmartbuild.com/puf-panel-manufacturer-in-nashik',
      ...
      <main id="main-content" className="flex-1">
        ...
        <section className="relative bg-gradient-to-br from-purple-900 via-fuchsia-900 to-slate-900 py-20 md:py-28">
          ...
          <div className="container-custom relative">
            <Breadcrumbs withSchema items={[{ label: 'Products', href: '/products' }, { label: 'PUF Panel Manufacturer in Nashik' }]} />
        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-purple-600 to-fuchsia-700 text-white">
          <div className="container-custom text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="https://wa.me/918866556879?text=Hi%20PHOENIXX,%20I%20need%20PUF%20panels%20in%20Nashik" target="_blank" rel="noopener noreferrer" className="rounded-xl border-2 border-white px-8 py-4 font-semibold text-white hover:bg-white/10 transition-all">💬 WhatsApp Enquiry</a>
            </div>
          </div>
        </section>
        <CityManufacturerAeo cityName="Nashik" />
